 ...
 * @author csx
 */
public class SpringMvcFrontServlet extends DispatcherServlet
{
	/**
	 * 
	 */
	...
	protected void noHandlerFound(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		String viewPath = ViewUtil.getFrontTmplByURI(requestURI, contextPath, ".htm");

		request.getRequestDispatcher("/WEB-INF/view"+viewPath + WebConstants.ACTIONHTM_POSTFIX).forward(request, response);
