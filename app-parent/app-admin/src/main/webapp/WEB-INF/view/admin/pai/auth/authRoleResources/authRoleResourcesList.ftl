        ...
        $(function ()
        {
        	searchForm = $("#form1").ligerForm({
				...
				fields : [
					...
					{ display: '资源Id', name: 'Q__S__EQ__resourceId', newline : false, align: 'left', width: 140 },
            ...
            grid = $("#maingrid").ligerGrid({
                ...
                columns: [
					...
					{ display: '资源Id', name: 'resourceId', align: 'left', width: 80, minWidth: 60 },
                ...
                url:'${CtxPath}/admin/pai/auth/authRoleResources/listData.do', 
                pageSize:30 ,
                rownumbers:true,
