    ...
    <script type="text/javascript">
        ...
        $(function ()
        {
        	searchForm = $("#form1").ligerForm({
				...
				fields : [
					{ display: '昵称:', name: 'Q__S__EQ__col.columnName', newline : true, align: 'left', width: 140 },
					{ display: '手机号:', name: 'Q__S__EQ__col.columnName', newline : false, align: 'left', width: 140 },
					{ display: '密码:', name: 'Q__S__EQ__col.columnName', newline : false, align: 'left', width: 140 },
					{ display: '邮箱:', name: 'Q__S__EQ__col.columnName', newline : false, align: 'left', width: 140 },
					{ display: '头像:', name: 'Q__S__EQ__col.columnName', newline : true, align: 'left', width: 140 },
					{ display: '行业:', name: 'Q__S__EQ__col.columnName', newline : false, align: 'left', width: 140 },
					{ display: '学校:', name: 'Q__S__EQ__col.columnName', newline : false, align: 'left', width: 140 },
					{ display: '专业:', name: 'Q__S__EQ__col.columnName', newline : false, align: 'left', width: 140 },
					{ display: '状态（1=正常；2=冻结）:', name: 'Q__S__EQ__col.columnName', newline : true, align: 'left', width: 140 },
					{ display: '性别（男，女）:', name: 'Q__S__EQ__col.columnName', newline : false, align: 'left', width: 140 },
					{ display: '密码后缀:', name: 'Q__S__EQ__col.columnName', newline : false, align: 'left', width: 140 },
					{ display: '个人简介:', name: 'Q__S__EQ__col.columnName', newline : false, align: 'left', width: 140 },
					{ display: '昵称状态（1=可修改；2=不可修改）:', name: 'Q__S__EQ__col.columnName', newline : true, align: 'left', width: 140 },
					{ display: '上次昵称修改时间:', name: 'Q__S__EQ__col.columnName', newline : false, align: 'left', width: 140 },
					{ display: '匿名用户对应id:', name: 'Q__S__EQ__col.columnName', newline : false, align: 'left', width: 140 },
					{ display: '创建人:', name: 'Q__S__EQ__col.columnName', newline : false, align: 'left', width: 140 },
					{ display: '创建时间:', name: 'Q__S__EQ__col.columnName', newline : true, align: 'left', width: 140 },
					{ display: '修改人:', name: 'Q__S__EQ__col.columnName', newline : false, align: 'left', width: 140 },
					{ display: '修改时间:', name: 'Q__S__EQ__col.columnName', newline : false, align: 'left', width: 140 },
            ...
            grid = $("#maingrid").ligerGrid({
                ...
                columns: [
					...
					{ display: '性别（男，女）', name: 'gender', align: 'left', width: 80, minWidth: 60 },
					{ display: '密码后缀', name: 'suffix', align: 'left', width: 80, minWidth: 60 },
					{ display: '个人简介', name: 'description', align: 'left', width: 80, minWidth: 60 },
					{ display: '昵称状态（1=可修改；2=不可修改）', name: 'nameStatus', align: 'left', width: 80, minWidth: 60 },
					{ display: '上次昵称修改时间', name: 'nameUpdateTime', align: 'left', type:'date', options:{showTime: true,format:'yyyy-MM-dd hh:mm:ss'}, width: 140, minWidth: 60 },
					{ display: '匿名用户对应id', name: 'fameId', align: 'left', width: 80, minWidth: 60 },
