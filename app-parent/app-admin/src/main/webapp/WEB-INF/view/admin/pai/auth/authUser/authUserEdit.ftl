    ...
    <#if authUserPo.createBy?exists>
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit">
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="createBy" type="text" id="createBy"  value="${authUserPo.createBy}" ltype="text" validate='{required:true}'/>
                </td>
                <td align="left"></td>
            </tr>    
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="createTime" type="text" id="createTime" class="wdateTime" onFocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="${authUserPo.createTime}" ltype="text" validate='{required:true,date:true}'/>
                </td>
                <td align="left"></td>
            </tr>    
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="updateBy" type="text" id="updateBy"  value="${authUserPo.updateBy}" ltype="text" />
                </td>
                <td align="left"></td>
            </tr>    
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="updateTime" type="text" id="updateTime" class="wdateTime" onFocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="${authUserPo.updateTime}" ltype="text" validate='{date:true}'/>
                </td>
                <td align="left"></td>
            </tr>    
        </table>
