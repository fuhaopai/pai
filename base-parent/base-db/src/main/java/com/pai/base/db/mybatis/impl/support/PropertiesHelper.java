package com.pai.base.db.mybatis.impl.support;
...
public class PropertiesHelper {
	...
	public static void main(String[] args) {
		...
		p.put("Dialect.oracle", "com.pai.base.db.mybatis.impl.dialect.OracleDialect");
		p.put("Dialect.mssql", "com.pai.base.db.mybatis.impl.dialect.SQLServer2005Dialect");
		p.put("Dialect.mysql", "com.pai.base.db.mybatis.impl.dialect.MySQLDialect");
		p.put("Dialect.db2", "com.pai.base.db.mybatis.impl.dialect.DB2Dialect");
		p.put("hello", "word");
