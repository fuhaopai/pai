package com.pai.base.db.mybatis.impl;
...
import com.pai.base.db.mybatis.impl.support.PropertiesHelper;
import com.pai.base.db.mybatis.impl.support.SQLHelp;
...
public class OffsetLimitInterceptor implements Interceptor{
	...
	public Object intercept(final Invocation invocation) throws Throwable {
        ...
        final MyBatisPage pageBounds = new MyBatisPage(rowBounds);
        //开始记录号
                ...
                countTask = new Callable() {
                    public Object call() throws Exception {
                        ...
                        if(cache != null && ms.isUseCache()){
                            CacheKey cacheKey = executor.createCacheKey(ms,parameter,new MyBatisPage(),copyFromBoundSql(ms,boundSql,bufferSql.toString()));
