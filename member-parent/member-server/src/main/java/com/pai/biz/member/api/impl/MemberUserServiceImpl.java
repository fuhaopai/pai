...
public class MemberUserServiceImpl implements MemberUserService {
	...
	@Override
    @AutoDocMethod(author = DeveloperType.FU_HAO, createTime = "2017-07-02 18:04:24", cver = VersionType.V100, module = ModuleType.MEMBER, name = "会员表单条查询", description = "查询返回会员表单条记录", sort = 2)
	public BaseResponse<MemberUserBean> getMemberUserServiceById(@AutoDocParam("会员id") String id){
	...
	@Override
    @AutoDocMethod(author = DeveloperType.FU_HAO, createTime = "2017-07-02 18:04:24", cver = VersionType.V100, module = ModuleType.MEMBER, name = "保存会员表", description = "保存会员表", sort = 3)
	...
	@Override
    @AutoDocMethod(author = DeveloperType.FU_HAO, createTime = "2017-07-02 18:04:24", cver = VersionType.V100, module = ModuleType.MEMBER, name = "删除会员表单条记录", description = "删除会员表单条记录", sort = 4)
	public BaseResponse deleteMemberUserById(@AutoDocParam("会员id") String id){
